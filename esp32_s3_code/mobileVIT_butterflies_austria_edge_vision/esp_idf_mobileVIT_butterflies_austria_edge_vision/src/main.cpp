...
constexpr const char *kModelName = "Butterflies Austria MobileViT";
constexpr const char *kModelPath =
    "/littlefs/mobilevit_int8.tflite";
...
struct ModelContext
{
  ...
  static constexpr int kInputWidth = 256;
...
bool initialize_interpreter()
{
  ...
  if (op_resolver.AddAdd() != kTfLiteOk ||
      ...
      op_resolver.AddBatchMatMul() != kTfLiteOk ||
      ...
      op_resolver.AddRsqrt() != kTfLiteOk ||
      op_resolver.AddSoftmax() != kTfLiteOk ||
      op_resolver.AddSquaredDifference() != kTfLiteOk ||
...
static void build_status_json(char *buf, size_t len)
{
  ...
  snprintf(buf, len,
           ...
           "\"input_shape\":[1,3,256,256],\"input_layout\":\"NCHW\","
           "\"input_dtype\":\"int8\","
