...
"""Compilation target for Intel OpenVINO SOCs."""
...
_INTEL_OPENVINO_BACKEND_ID = "intel_openvino"


# TODO(b/506632108): Generate this from supported_soc.csv.
class SocModel(StrEnum):
  """Intel NPU SOC model."""

  ALL = "ALL"

  LNL = "LNL"  # NPU4000, Lunar Lake
  PTL = "PTL"  # NPU5010, Panther Lake


class SocManufacturer(StrEnum):
  """Intel SOC manufacturer."""
...
class Target(aot_types.Target):
  ...
  soc_model: SocModel
  soc_manufacturer: SocManufacturer = SocManufacturer.INTEL

  @classmethod
  def backend_id(cls) -> str:
    return _INTEL_OPENVINO_BACKEND_ID
