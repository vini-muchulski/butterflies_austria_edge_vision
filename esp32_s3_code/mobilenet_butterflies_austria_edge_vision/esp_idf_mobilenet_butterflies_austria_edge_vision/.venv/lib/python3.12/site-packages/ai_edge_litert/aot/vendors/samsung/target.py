...
# ==============================================================================
"""Compilation target for Samsung SOCs."""
...
class Target(aot_types.Target):
  ...
  soc_model: SocModel
  soc_manufacturer: SocManufacturer = SocManufacturer.SAMSUNG

  @classmethod
  def backend_id(cls) -> str:
    return _SAMSUNG_BACKEND_ID
