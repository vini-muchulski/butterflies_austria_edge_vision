...
TfLiteRegistration_V1 Register_BATCH_MATMUL();
...
// implementations.
TfLiteRegistration_V1 Register_BATCH_MATMUL_INT8();

// Returns a TFLMRegistration struct for kernel variant that only supports
// int16 matrix multiplication and uses the latency optimized
// implementations.
TfLiteRegistration_V1 Register_BATCH_MATMUL_INT16();

#else
inline TfLiteRegistration_V1 Register_BATCH_MATMUL_INT8() {
  return Register_BATCH_MATMUL();
}

inline TfLiteRegistration_V1 Register_BATCH_MATMUL_INT16() {
  return Register_BATCH_MATMUL();
}
